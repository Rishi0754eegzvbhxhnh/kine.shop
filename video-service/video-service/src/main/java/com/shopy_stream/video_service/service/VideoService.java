package com.shopy_stream.video_service.service;

import com.shopy_stream.video_service.event.VideoUploadedEvent;
...
public class VideoService {
    ...
    public void deleteVideo(String videoKey) {
        log.info("Deleting video from S3 with key: {}", videoKey);
        ...
        log.info("Video deleted from S3 successfully");
    }
}